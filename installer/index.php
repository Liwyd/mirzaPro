...
if(!file_exists($configDirectory) || !file_exists($tablesDirectory)) {
    ...
    $ERROR[] = "فایل های پروژه را مجددا دانلود و بارگذاری کنید (<a href='https://github.com/Liwyd/mirzaPro/releases/'>‎🌐 Github</a>)";
}
if(phpversion() < 8.2){
...
<body>
    <div class="container">
        ...
        <footer>
            <p>mirzaPro Installer , Made by ♥️ | <a href="https://github.com/Liwyd/mirzaPro/releases/">Github</a> | &copy; <?php echo date('Y'); ?></p>
        </footer>
    </div>
        <script>
